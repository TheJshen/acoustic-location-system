...
D = int(sys.argv[7])                                            #Depth (0 - 100) in meters
...
f = open ("out_freq_loc_fine.txt", "a")

string = "frequencies: a=%i b=%i c=%i , x = %i, y = %i, D = %i, cx = %f, cy = %f, xerr = %f, yerr = %f \t  totalERROR= %f \n" %(f1, f2, f3, xs, ys, D, x, y, xerr,yerr,totale)
f.write(string)
