...
D = int(sys.argv[1])                                            #Depth (0 - 100) in meters
...
pbw = int(sys.argv[4]); # Passband width in hertz
fOrder = 63; # Filter order number now the most optimal 
